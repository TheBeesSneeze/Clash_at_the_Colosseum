...
public abstract class BulletEffect : ScriptableObject
{
    ...
    [Tooltip("*IF* the bullet effect has a component that does damage, that damage " +
        "is determined by multiplying the current shootmodes damage (per bullet) by this number")]
